...
public class Utils {
    ...
    public static void showFadeOutDialog(final ViewGroup parent, final Context context, String text1, String text2, int imageId) {
    ...
    public static void showPermanentDialog(ViewGroup parent, final Context context, String text1, String text2, int imageId) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final RelativeLayout dialog = (RelativeLayout) inflater.inflate(R.layout.dialog_succesful, null);
